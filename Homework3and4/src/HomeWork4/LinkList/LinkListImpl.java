...
public class LinkListImpl<E> implements LinkList<E>
{
  ...
  public boolean remove(E value)
  {
    ...
    {
      if (currentElement.value.equals(value)) break;
    ...
    if (currentElement == firstElement) firstElement = firstElement.next;
  ...
  public boolean contains(E value)
  {
    ...
    while (currentElement != null)
    {
      if (currentElement.value.equals(value)) return true;
      currentElement = currentElement.next;
    }
